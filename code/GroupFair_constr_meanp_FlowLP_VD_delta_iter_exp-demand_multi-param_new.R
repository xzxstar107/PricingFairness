...
# setwd('E:/research/Prof.Chen/20221013/github/20221129_experiment/TV')
# setwd('E:/research/Prof.Chen/20221013/github/20221129_experiment/EM')
setwd('E:/research/Prof.Chen/20221013/github/20221129_experiment/Constr')
...
for (i2 in paramvec0) {
  for (i3 in paramvec0) {
      for (j2 in paramvec) {
        for (j3 in paramvec) {
            ...
            # summary(V)
            #   Min.    1st Qu. Median    Mean    3rd Qu.   Max. 
            # 0.00182  0.71651  1.80252  2.78517  3.65740 42.42359 
  ...
  for(j in 1:l){
    ...
    # output results
    write.csv(opt_res, file = paste0("res_const_meanp_VD_multi-delta_expDemand_params_",i1,i2,i3,j1,j2,j3,"_new.csv"))
      }       
    }
       } 
        }
