...
# Save results
    ...
    # output results
    write.csv(opt_res, file = paste0("res_EMconstr_VD_multi-delta_ExpDemand_params_",i1,i2,i3,j1,j2,j3,"_new.csv"))
      } 
...
# Save results
    ...
    # output results
    write.csv(opt_res, file = paste0("res_EMconstr_VD_multi-delta_logisticDemand_params_",i1,i2,i3,j1,j2,j3,t1,t2,t3,"_new.csv"))
      } 
